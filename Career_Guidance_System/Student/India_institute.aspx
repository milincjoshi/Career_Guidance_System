<%@ Page Language="C#" AutoEventWireup="true" CodeFile="India_institute.aspx.cs" Inherits="Student_India_institute" %>


<!DOCTYPE html>
<html lang="en">
<head>
  	<title>Indian Institutes</title>
  	<meta charset="utf-8">
                ...
                <div class="content-bottom">
                 	<div class="container_12">
                    	<div class="wrapper pad-top2">
                            ...
                            <div class="grid_8">
                            	<div class="pad-left">
                                	<div class="title-3">Our global most respected clients include:</div>
                                    <div class="bunner-top">
                                    	<asp:DataList ID="lst1" runat="server" RepeatColumns="3">
                                        <ItemTemplate>
                                       
                                        <div class="col-1">
                                        	<a href="more.html">
                                            <img src='<%# Eval("logo") %>' width="100px" height="100px" alt="" class="shadow"></a><br>
                                          <%# Eval("Name") %></a>
                                          <br>
                                          <%# Eval("City") %> - <%# Eval("State") %> - <%# Eval("Country") %>
                                          <a href='<%# "institute_details.aspx?Id_institute=" + Eval("Id_institute") %>' class="link4"> View Details </a>
                                        </div>
